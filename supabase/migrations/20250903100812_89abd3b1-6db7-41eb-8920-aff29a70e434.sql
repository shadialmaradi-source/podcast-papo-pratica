-- Add 10 exercises for each episode
...
('ex-pt-004', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'Verdadeiro ou falso: "Obrigado" significa "please".', 'multiple_choice', '["Verdadeiro", "Falso"]', 'Falso', 'Obrigado significa "thank you", não "please".', 'A1', 5, 4),
...
INSERT INTO exercises (id, episode_id, question, exercise_type, options, correct_answer, explanation, difficulty, xp_reward, order_index) VALUES
('ex-es-001', 'c3d4e5f6-a7b8-9012-cdef-123456789012', '¿Cómo se dice "hello" en español?', 'multiple_choice', '["Adiós", "Hola", "Gracias", "Por favor"]', 'Hola', 'Hola es la forma más común de saludar en español.', 'A1', 5, 1),
('ex-es-002', 'c3d4e5f6-a7b8-9012-cdef-123456789012', 'Completa: "Yo _____ español."', 'fill_blank', NULL, 'hablo', 'El verbo "hablar" se usa para expressar que hablas un idioma.', 'A1', 5, 2),
('ex-es-003', 'c3d4e5f6-a7b8-9012-cdef-123456789012', '¿Cuál es la respuesta a "¿Cómo estás?"', 'multiple_choice', '["Gracias", "Estoy bien", "Por favor", "Lo siento"]', 'Estoy bien', 'Estoy bien es la respuesta estándar para "¿Cómo estás?".', 'A1', 5, 3),
('ex-es-004', 'c3d4e5f6-a7b8-9012-cdef-123456789012', 'Verdadero o falso: "Gracias" significa "please".', 'multiple_choice', '["Verdadero", "Falso"]', 'Falso', 'Gracias significa "thank you", no "please".', 'A1', 5, 4),
('ex-es-005', 'c3d4e5f6-a7b8-9012-cdef-123456789012', '¿Cómo se dice "goodbye"?', 'multiple_choice', '["Hola", "Adiós", "Buenos días", "Buenas noches"]', 'Adiós', 'Adiós se usa para despedirse.', 'A1', 5, 5),
('ex-es-006', 'c3d4e5f6-a7b8-9012-cdef-123456789012', 'Completa: "¡_____ días!"', 'fill_blank', NULL, 'Buenos', 'Buenos días es el saludo matutino.', 'A1', 5, 6),
('ex-es-007', 'c3d4e5f6-a7b8-9012-cdef-123456789012', '¿Cuál es el artículo definido masculino?', 'multiple_choice', '["La", "El", "Los", "Las"]', 'El', 'El es el artículo definido masculino singular.', 'A1', 5, 7),
('ex-es-008', 'c3d4e5f6-a7b8-9012-cdef-123456789012', '¿Cómo se dice "water"?', 'multiple_choice', '["Leche", "Agua", "Café", "Té"]', 'Agua', 'Agua es water en español.', 'A1', 5, 8),
('ex-es-009', 'c3d4e5f6-a7b8-9012-cdef-123456789012', 'Completa: "Yo quiero _____ café."', 'fill_blank', NULL, 'un', 'Un es el artículo indefinido masculino.', 'A1', 5, 9),
('ex-es-010', 'c3d4e5f6-a7b8-9012-cdef-123456789012', '¿Cómo se pregunta el nombre?', 'multiple_choice', '["¿Cuál es tu nombre?", "¿Cómo estás?", "¿Dónde vives?", "¿Cuántos años tienes?"]', '¿Cuál es tu nombre?', 'Esta es la forma educada de preguntar el nombre.', 'A1', 5, 10);