...
serve(async (req) => {
  ...
  try {
    ...
    // Validate the JWT before doing any service-role work to prevent
    // unauthenticated callers from triggering expensive AI calls or reading
    // privileged data via the service-role client.
